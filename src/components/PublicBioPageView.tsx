        ...
        ? effectiveDevice === "mobile"
          ...
          : effectiveDevice === "tablet"
            ...
            : effectiveDevice === "laptop"
              ...
              : effectiveDevice === "desktop"
                ? "w-full max-w-7xl key-public-bio-page--desktop mx-auto min-h-screen rounded-none border-0 shadow-none px-4 sm:px-6 md:px-8 py-6"
                : effectiveDevice === "tv"
                  ? "w-full max-w-[1920px] key-public-bio-page--tv mx-auto min-h-screen rounded-none border-0 shadow-none px-6 md:px-12 py-8"
                  : "w-full max-w-7xl key-public-bio-page--auto mx-auto min-h-screen rounded-none border-0 shadow-none px-4 sm:px-6 md:px-8 py-6"
        : effectiveDevice === "mobile"
